...
MODEL_TYPE = 'global'         # 'global', 'c_only', 'h_only'
AD_PERCENTILE = 95
# ==============================================
...
x_upper = 60
# 直方图
ax.hist(train_dist, bins=60, alpha=0.6, color='steelblue', density=False,
        range=(0, x_upper), label=f'Training Set (n={len(train_dist)})')
ax.hist(test_dist, bins=60, alpha=0.5, color='orange', density=False,
